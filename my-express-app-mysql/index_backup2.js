...
app.get('/', timingMiddleware, (req, res) => {  
    ...
    res.send(`Homepage by mdestagreddy<br><br>
        ...
        <form action="/api/movies">Cari film melalui JSON: <input name="keyword" type="search" /><input type="submit" value="Cari" /><input type="hidden" name="token" value="${tokenAPI}" /></form>`)
})
